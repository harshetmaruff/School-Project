  ...
  return (
    <div className='flex-1 ml-4'>
        <div className='flex flex-row justify-between mt-4'>
            <h2 className='text-darkviolette font-bold text-2xl '>Invoice</h2>
            ...
            <table className='w-full  table-auto'>
                <thead>
                    <tr className='border-b-4 border-darkviolette'>
                        ...
                        <th className='text-left p-1'>SalesPerson</th>
                ...
                <tbody>
                    <tr className='bg-bwhite'>
                        <td className='p-2'>Deco Addict</td>
                        <td className='p-2'>18/01/2025</td>
                        <td className='p-2'>INV/2025/0003</td>
                        <td className='p-2'>Demo marc</td>
