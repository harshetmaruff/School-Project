...
const Sidebar = ({selected, option}) => {
  ...
  return (
    ...
    <div className=' h-screen bg-darkviolette w-18 pt-4 pb-4 pl-2 flex flex-col'>
      <div>
        <div className={`mt-8 mb-4 p-2 rounded-l-lg  ${ (selected == "Analytics") ? "bg-lightviolette" : "hover:bg-indigopurple" }`}><img src={AnalyticsLogo} className='w-16' alt="" /></div>
        ...
        <div className={`mt-4 mb-4  p-2 rounded-l-lg  ${ (selected == "eCommerce") ? "bg-lightviolette" : "hover:bg-indigopurple" }`}><NavLink to="/ecommerce/orders"><img src={ShoppingCart} className='w-16' alt="" /></NavLink></div>
