...
CREATE TABLE users (
    ...
    user_role_id INT,
    CONSTRAINT fk_user_role FOREIGN KEY (user_role_id) REFERENCES user_role(id) ON DELETE SET NULL
);
...
INSERT INTO users (email, user_role_id, username, password_hash)
